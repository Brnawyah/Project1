...
for labels_pred in list_P:
       ...
       if len(bndObjects)!= 0:
           ...
           BND_regions= (set(BND_Module_attribute) - set(Pos_Module_attribute))
...
postive_AHC_results= sum((cut_tree(linked, n_clusters = number_cluster).T).tolist(),[]) 
